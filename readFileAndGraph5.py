...
def addlabels(ax, x, y, width):
    ...
    for i in range(len(x)):
        ...
        ax.text(x[i] + width / 2, y[i] + 5, y[i], color='#333333', fontsize=13, fontweight='bold', ha='center', va='bottom', rotation=90, path_effects=[path_effects.withStroke(linewidth=3, foreground='white')]) #modified fontsize
